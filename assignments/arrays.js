...
// ES5
const carId = inventory.filter(function (car) {
    if (car.id === 33) {
        return true;
    }
})
// ES6
// const carId = inventory.filter(car => car.id === 33);
console.log(carId);
...
// ES5
let lastCar = 0;
const finalCar = inventory.filter(function (car) {
    if (car.id === 50) {
        return true;
    }
})
...
// ES6
// const finalCar = inventory.filter(car => car.id === 50);
console.log(finalCar);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
const sortedCars = inventory.sort(function (car1, car2) {
